...
if (count($errors) > 0) {
  ...
  try {
    ...
    // insert new data in emp table
    $pdo->insertData("emp", "fname, lname, gender, email, address, salary, password, image", "'$fname', '$lname', '$gender', '$email', '$address', '$salary', '$password', '$imageBaseName'");
